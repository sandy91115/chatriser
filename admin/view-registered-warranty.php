...
<head>
    ...
    <title>View Registered Warranty</title>
            ...
            <div class="col-12">
                <div class="page_title_box d-flex align-items-center justify-content-between">
                    <div class="page_title_left">
                        <h3 class="f_s_30 f_w_700 text_white">View registered warranty</h3>
                        <ol class="breadcrumb page_bradcam mb-0">
                            ...
                            <li class="breadcrumb-item active">View registered warranty</li>
                        </ol>
                    </div>
                            ...
                            <div class="white_card_body">
                                <div class="QA_section">
                                    <div class="white_box_tittle list_header">
                                        <h4>Registered Warranty Table</h4>
                                            ...
                                            <table class="table lms_table_active ">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th scope="col">Dealer Pincode</th>
                                                        <th scope="col">Dealer State</th>
                                                        <th scope="col">Dealer City</th>

                                                        <th scope="col">Status</th>
                                                        <th scope="col">Registraion on</th>
                                                        <th scope="col">Action</th>

                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <?php get_warranty_registrations(); ?>
                                                </tbody>
                                            </table>
                                        </div>
                                    </div>
