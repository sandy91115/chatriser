                                                ...
                                                <form action="function.php" method="POST" enctype="multipart/form-data">
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <input type="text" class="form-control" name="requirements" placeholder="Job Description">
                                                        </div>
                                                        <div class="col-md-6 mb-3">
                                                            <label class="form-label" for="inputEmail4">Experience</label>
                                                            <input type="text" class="form-control" name="experience" placeholder="Job Description">
                                                        </div>
                                                        <div class="col-md-6 mb-3">
                                                            <label class="form-label" for="inputEmail4"> Canditate Qualifications</label>
                                                            <input type="text" class="form-control" name="qualifications" placeholder="Candidate Qualifications">
                                                        </div>
                                                        <div class="col-md-6 mb-3">
                                                            <label class="form-label" for="inputEmail4">Candidate Responsibilities</label>
                                                            <input type="text" class="form-control" name="responsibilities" placeholder="Candidate Responsibilities">
                                                        </div>
                                                        <div class="col-md-6 mb-3">
                                                            <label class="form-label" for="inputEmail4">Benefits and Perks</label>
                                                            <input type="text" class="form-control" name="benefits" placeholder="Benefits and Perks">
                                                        </div>
                                                        <div class="col-md-6 mb-3">
                                                        ...
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <input class="form-control" name="job_location" placeholder="Job Location">
                                                        </div>
