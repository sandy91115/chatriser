...
<head>
    ...
    <title>View Catalogue Enquiry</title>
            ...
            <div class="col-12">
                <div class="page_title_box d-flex align-items-center justify-content-between">
                    <div class="page_title_left">
                        <h3 class="f_s_30 f_w_700 text_white">Catalogue Enquiry</h3>
                        <ol class="breadcrumb page_bradcam mb-0">
                            ...
                            <li class="breadcrumb-item active">Catalogue Enquiry</li>
                        </ol>
                    </div>
