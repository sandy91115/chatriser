...
<!-- Bootstrap JS (correct extension and updated link) -->
...
<script src="./assets/vendors/animation/wow/wow.min.js"></script>
<script src="./assets/vendors/animation/wow/wow-init.js"></script>
