                                                ...
                                                <form action="function.php" method="POST" enctype="multipart/form-data">
                                                    <div class="row mb-3">
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="text" class="form-control" name="cate_name" id="categoryname" placeholder="Category Name">
                                                        </div>
                                                        <div class="col-md-6 mb-3 ">
                                                            <label class="form-label" for="inputEmail4">Category Tagline</label>
                                                            <input type="text" class="form-control" name="cate_tagline" id="inputEmail4" placeholder="Category Tagline">
                                                        </div>
                                                        <div class="col-md-6 mb-3">
                                                            <label class="form-label" for="inputEmail4">Category Image</label>
